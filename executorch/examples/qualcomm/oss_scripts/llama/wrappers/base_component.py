...
def process_model_args(
    ...
    if quant_recipe is not None:
        ...
        # fp16/fp32 without quantization: infer from dtype_override
        dtype = getattr(control_args, "dtype_override", "fp32")
        model_args.kv_io_bit_width = 16 if dtype == "fp16" else 32
